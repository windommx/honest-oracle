...
import { MODULE_GROUPS, defaultGroupsFor } from "@/lib/bookisdom-engine/modules";
import { NARRATIVE_STRUCTURES, structureById } from "@/lib/bookisdom-engine/thai-structures";
import { BOOTSTRAPS, bootstrapQuery } from "@/lib/bookisdom-engine/bootstraps";

type GroupKey = (typeof MODULE_GROUPS)[number]["key"];
const STEPS = ["ประเภท", "แนวย่อย + ภาษา", "ความยาว", "โมดูลเสริม", "สรุป"];

export default function BookisdomStart() {
      ...
      <div className="max-w-3xl mx-auto px-5 py-12">
        ...
        {step === 0 && (
          <section>
            ...
            <div className="mt-10">
              <h3 className="text-sm font-semibold text-slate-700 mb-1">หรือเริ่มเร็วจากแม่แบบตั้งต้น ({BOOTSTRAPS.length})</h3>
              ...
              {MODULE_GROUPS.map((g) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span>
                      <span className="block text-sm font-medium text-slate-900">{g.label}</span>
        ...
        {step === 4 && (
          <section>
            ...
            <dl className="rounded-xl border border-black/10 divide-y divide-black/5 text-sm">
              {[
        ...
        <div className="flex items-center justify-between mt-10">
          <button
            ...
            disabled={step === 0}
            className="inline-flex items-center gap-1.5 text-sm px-4 py-2 rounded-lg border border-black/10 text-slate-700 hover:bg-black/[0.04] disabled:opacity-30 disabled:cursor-not-allowed"
          >
