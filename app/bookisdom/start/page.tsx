    ...
    <main className="min-h-screen bg-[#0b0e17] text-slate-200">
      <div className="max-w-3xl mx-auto px-5 py-12">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs tracking-[0.2em] uppercase text-[#ab5bf7] font-semibold">Bookisdom Studio · สร้าง Prompt Pack</p>
          <div className="flex items-center gap-3">
            <Link href="/bookisdom/fix" className="text-xs text-faint hover:text-slate-300">ติดอยู่? หาจากอาการ</Link>
            <Link href="/bookisdom/explore" className="text-xs text-faint hover:text-slate-300">← ดู 8 ประเภท</Link>
          </div>
        </div>
