...
import { ALLOWED_HEX, AUDIT_COLOR, BG, GROUP_COLOR, GROUP_LABEL, PALETTE } from "./_tokens";
import { BASE_PALETTE } from "@/lib/design/tokens";
import { PANELS } from "./_panels";

const DIR = join(process.cwd(), "app", "master");
...
describe("app/master design tokens", () => {
  ...
  it("the audit's three states are three different colours", () => {
    const values = Object.values(AUDIT_COLOR);
