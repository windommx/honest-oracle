      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-6 items-center">
            ...
            <Link href="/lifemap/api-keys" className="text-gray-700 hover:text-[#1e40af] transition-colors">
              API Keys
            </Link>
          </div>
        </div>
          ...
          <div className="glass-card rounded-2xl p-6">
            {loading ? (
              ...
              <div className="text-gray-600 text-sm text-center py-10">
                ยังไม่มีประวัติ{" "}
                <Link href="/lifemap/app" className="text-[#1d4ed8] font-semibold">
                  สร้างแผนที่แรก
                </Link>
              </div>
            ) : (
              <div className="space-y-3">
                {items.map((r) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className="text-[#111827]/90 font-semibold">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        <Link
                          ...
                          className="px-3 py-2 bg-black/[0.03] border border-[#1d4ed8]/25 text-[#111827] rounded-xl hover:border-[#1d4ed8]/50 transition-colors text-sm"
                        >
                          ดู JSON
                        </Link>
                        {share && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="px-3 py-2 bg-[#3c74d4] text-white font-semibold rounded-xl hover:bg-[#3366bf] transition-colors text-sm"
                          >
                            เปิดลิงก์แชร์
                          </a>
                        )}
