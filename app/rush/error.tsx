  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6" style={{ background: "#0b0e17" }}>
      <div className="max-w-md w-full text-center border border-white/10 rounded-2xl p-8 bg-[#151a27]">
        <p className="text-xs tracking-[0.2em] uppercase text-[#ab5bf7] font-semibold mb-3">Rush · เกิดข้อผิดพลาด</p>
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <a href="/rush/dashboard" className="px-5 py-2.5 rounded-xl border border-white/10 text-sm text-slate-300 hover:bg-white/5 transition-colors">
            กลับแดชบอร์ด
          </a>
        </div>
      </div>
