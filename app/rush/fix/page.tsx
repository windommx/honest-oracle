    ...
    <main className="min-h-screen bg-[#0b0e17] text-slate-200">
      <div className="max-w-3xl mx-auto px-5 py-12">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs tracking-[0.2em] uppercase text-[#ab5bf7] font-semibold">Rush · หาโมดูลจากอาการ</p>
          <Link href="/rush/start" className="text-xs text-faint hover:text-slate-300">เริ่มเล่มใหม่ →</Link>
        </div>
