    ...
    <main className="min-h-screen bg-[#0a0a0f] text-gray-200">
      <div className="max-w-3xl mx-auto px-5 py-12">
        <div className="flex items-center justify-between mb-2">
          ...
          <Link href="/rush/start" className="text-xs text-faint hover:text-gray-300">เริ่มเล่มใหม่ →</Link>
        </div>
        ...
        <label className="block relative mb-4">
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/10 bg-white/[0.03] pl-10 pr-4 py-3 text-sm text-gray-100 placeholder:text-faint focus:border-[#c9a84c] focus:outline-none"
          />
        </label>
