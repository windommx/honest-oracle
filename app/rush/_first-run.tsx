...
// ║  find.                                                             ║
// ║                                                                    ║
// ║  Measured problem, not a hunch: /rush is the most-linked page in    ║
// ║  the app (8 inbound links) and it linked to /rush/start,            ║
// ║  /rush/explore and /rush/fix ZERO times. Someone landing on the     ║
...
// ║  five rush pages were unreachable from the front door.              ║
// ║                                                                    ║
...
const DISMISS_KEY = "rush.orientation.dismissed";
