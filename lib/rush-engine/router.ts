...
export const SYMPTOM_LADDER: Rung[] = [
  ...
  },
  {
    ...
    keywords: ["ไม่ตรงกัน", "ขัดกัน", "ขัดแย้ง", "สะกดไม่เหมือน", "ลืมว่า", "ไทม์ไลน์", "timeline", "continuity", "contradict", "inconsistent"],
    primary: "WORLD_CODEX",
  ...
  },
  {
    ...
    keywords: ["แบน", "เนือย", "ไม่มีอะไรเกิดขึ้น", "น่าเบื่อ", "จืด", "ไม่มีอะไร", "flat", "boring", "nothing happens", "dull"],
    primary: "SCENE",
  ...
  },
  {
    ...
    keywords: ["ไม่อิน", "ไม่รู้สึก", "ห่างเหิน", "เข้าไม่ถึง", "ไม่ดึงดูด", "not immersed", "distant", "detached", "no emotion"],
    primary: "IMMERSION",
  ...
  },
  {
    ...
    keywords: ["ช้า", "หย่อน", "อืด", "กลางเรื่อง", "เร่ง", "จังหวะ", "pacing", "saggy middle", "rushed ending", "drags"],
    primary: "NIS_PACING",
  ...
  },
  {
    ...
    keywords: ["ปูแล้วไม่เก็บ", "ไม่เก็บ", "ปม", "foreshadow", "payoff", "setup", "ค้างคา", "loose end", "unresolved"],
  ...
  },
  {
    ...
    keywords: ["ยาวเกิน", "เยิ่นเย้อ", "ตัดไม่ลง", "ฟุ่มเฟือย", "น้ำเยอะ", "wordy", "bloated", "too long", "cut", "trim"],
    primary: "CUT_PASS",
  ...
  },
  {
    ...
    keywords: ["ชื่อเรื่อง", "เรื่องย่อ", "ปก", "ขายไม่ออก", "การตลาด", "คีย์เวิร์ด", "title", "blurb", "cover", "kdp", "metadata", "marketing"],
    primary: "BLURB",
