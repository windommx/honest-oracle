// ╔══════════════════════════════════════════════════════════════════╗
// ║  PROVENANCE — the receipt. Every number Rush reports, with the     ║
// ║  instrument that made it and the command that re-makes it.         ║
// ║                                                                    ║
// ║  Adapted from the "evidence chain" idea in zhaoxuya520/reverse-    ║
// ║  skill's ops contracts (MIT). Rush's router commit refused that    ║
...
// ║  proves what you COMPUTED, which is the thing Rush's whole pitch   ║
...
// ║                                                                    ║
// ║  NO TIMESTAMP, ON PURPOSE. Rush has no clock in output paths, and  ║
