...
export const RIVALS: Rival[] = [
  ...
  // that contest Rush's measured-signal claim most directly. Hemingway's core is pure
...
const ROWS: Row[] = [
  //                                                            rush nc  su  nai boo aiw squ fic pwa raw sc  scr att plo dab lw  aut mar gra hem wan
