...
// ║                                                                    ║
// ║  Bookisdom classifies every NUMBER it reports by what kind of knowing   ║
...
export interface Citation {
  ...
  usedIn: string[];
  /** What Bookisdom uses it FOR — one line. The claim, not the topic. */
  claim: string;
  tier: CiteTier;
...
export const CITATIONS: Citation[] = [
  ...
  },
  {
    ...
    tier: "disputed",
    note: "Dale's Cone of Experience contains no numbers. Asked for the source, NTL Institute replied it no longer has and cannot find the original research. The strongest kind of citation Bookisdom can carry: a number with a documented absence of origin.",
  },
  {
    id: "power-pose",
    who: "Cuddy; Ranehill",
  ...
  },
  {
    ...
    tier: "disputed",
    note: "The famous 'pistol in act one' phrasing is Gurlyand's memoir, not Chekhov. Bookisdom cites the letter, which Chekhov actually wrote. Registered as disputed so the misattribution cannot creep back in.",
  },
  ...
  },
  {
    ...
    tier: "index",
    note: "Bookisdom prints BOTH reported figures because they disagree: the abstract reports 1.6-2.1x on creative-writing tasks while the project repo advertises 2-3x. Author-reported and unreplicated either way.",
  },
  {
    id: "testing-effect",
