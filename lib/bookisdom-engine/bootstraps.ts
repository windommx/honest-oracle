...
// ║  + length + narrative structure) that deep-links into /bookisdom via    ║
...
export interface Bootstrap {
  ...
  chapters: number;    // 1..100 (the /bookisdom deep-link cap)
...
/** Deep-link query for /bookisdom — matches the params the generator page already reads. */
